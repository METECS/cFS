    ...
    */ 
    {
        ...
        union {
           CFE_SB_Msg_t attr1;
           bcamp_io_hk_tlm_t attr2;
        } tempMessage;

	memcpy(&tempMessage, &Bcamp_IO_AppData.BCAMP_IO_HkTelemetryPkt, sizeof(tempMessage));
         ...
         */
        memcpy(&Bcamp_IO_AppData.BCAMP_IO_HkTelemetryPkt, &tempMessage, sizeof(tempMessage));
    }
